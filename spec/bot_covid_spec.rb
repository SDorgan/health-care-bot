...
describe 'BotClientCovidCommands' do
  ...
  it 'should only be available for clients' do # rubocop:disable RSpec/ExampleLength
    ...
    stub_request(:head, "#{ENV['API_URL']}/afiliados/141733544")
  ...
  it 'when user test covid diagnosis with breath problems suspicious receives covid suspicious' do # rubocop:disable RSpec/ExampleLength, Metrics/BlockLength
    options_temp = [
      [{ "text": '35 o menos', "callback_data": '35' }],
      [{ "text": '36', "callback_data": '36' }],
      [{ "text": '37', "callback_data": '37' }],
  ...
  it 'when user test covid diagnosis selecting one of the last selection question that is no Ninguna suspicious receives covid suspicious' do # rubocop:disable RSpec/ExampleLength, Metrics/BlockLength
    options_temp = [
      [{ "text": '35 o menos', "callback_data": '35' }],
      [{ "text": '36', "callback_data": '36' }],
      [{ "text": '37', "callback_data": '37' }],
    ...
    stub_get_updates_callback_query(token, 'Última: elija una opción',
                                    options_last_question,
                                    CovidLastSelectionQuestion::OPT_CARD[:id])
